...
# 项目
CREATE_PROJECT      = "创建项目|Create project.py"
UPDATE_PROJECT_INFO = "更新项目信息|Update project.py information"
DELETE_PROJECT      = "删除项目|Delete project.py"
...
BIND_PROJECT_MEMBER            = "绑定项目成员|Binding project.py members"
UNBIND_PROJECT_MEMBER          = "解绑项目成员|Unbind project.py members"
UPDATE_PROJECT_MEMBER_ROLE     = "更新项目成员权限|Update project.py member permissions"
BIND_PROJECT_RESOURCE_PLAN     = "绑定项目资源(部署计划)|Binding project.py resources(plan)"
BIND_PROJECT_RESOURCE_BACKUP   = "绑定项目资源(备份账号)|Binding project.py resources(backup_account)"
BIND_PROJECT_RESOURCE_HOST     = "绑定项目资源(主机)|Binding project.py resources(host)"
UNBIND_PROJECT_RESOURCE_PLAN   = "解绑项目资源(部署计划)|Unbind project.py resources(plan)"
UNBIND_PROJECT_RESOURCE_BACKUP = "解绑项目资源(备份账号)|Unbind project.py resources(backup_account)"
UNBIND_PROJECT_RESOURCE_HOST   = "解绑项目资源(主机)|Unbind project.py resources(host)"
