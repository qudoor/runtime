...
from apps.common.management.commands.services.utils import ServicesUtil
from apps.common.management.commands.services.hands import *
...
class Services(TextChoices):
    ...
    def get_service_object_class(cls, name):
        ...
        services_map = {
            ...
            cls.celery: services.CeleryBaseService,
