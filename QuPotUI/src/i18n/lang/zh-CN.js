...
const message = {
  ...
  cluster: {
    ...
    condition: {
      ...
      EnsureInitServiceConfig: "初始化服务器配置",
      EnsureInitNvidiaConfig: "初始化 NVIDIA ",
      EnsureInitCudaConfig: "初始化 CUDA",
      EnsureInitCuquantumConfig: "初始化 CUDA",
  ...
  setting: {
    ...
    password_help: "admin 用户默认密码为 ****123",
    ntp: "NTP",
    email: "邮箱",
    license: "许可证",
