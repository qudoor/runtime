<template>
  <layout-content :header="$t('commons.button.upgrade')" :back-to="{ name: 'TaskList' }">
    <el-row>
        ...
        <div class="grid-content bg-purple-light">
          <el-form :model="form" ref="form" :rules="rules" label-width="120px">
            ...
            <el-form-item style="float: right">
              ...
              <el-button type="primary" v-loading="loadding" @click="onSubmit" v-preventReClick>{{ $t("commons.button.ok") }}</el-button>
            </el-form-item>
          </el-form>
        </div>
      </el-col>
...
import { upgradeCluster, getTaskByName } from "@/api/task"
...
export default {
  ...
  methods: {
    ...
    loadInfo(clusterName) {
      getTaskByName(clusterName).then((data) => {
