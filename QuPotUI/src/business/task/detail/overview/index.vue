...
export default {
  ...
  methods: {
    // downloadKubeConfig() {
    //   window.open(`/api/v1/clusters/kubeconfig/${this.taskName}`, "_blank")
    // },
    search() {
      this.taskName = this.$route.params.name
      console.log('this.taskName :>> ', this.taskName);
      console.log('route:>> ', this.taskName);
      getTaskByName(this.taskName).then((data) => {
    ...
    //   this.opened = true
    //   getClusterToken(this.taskName).then((data) => {
    ...
    // },
    // loadNameSpaces() {
    //   listNamespace(this.taskName).then((data) => {
    //     this.namespaces = data.items
    //   })
    // },
    // loadPods() {
    //   listPod(this.taskName).then((data) => {
    ...
    // },
    // loadNodes() {
      //   listNodeInCluster(this.taskName).then((data) => {
    ...
    // },
    // loadDeployments() {
    //   listDeployment(this.taskName).then((data) => {
    //     this.deployments = data.items
    //   })
    // },
    // loadNodesUsages() {
    //   listNodesUsage(this.taskName).then((data) => {
