        ...
        <div class="grid-content bg-purple-light">
          <el-form label-position='left' ref="form" :model="form" :rules="rules" label-width="160px">
            <el-form-item :label="$t('commons.table.name')" prop="name">
              ...
              <div><span class="input-help">{{$t('commons.validate.host_name_help')}}</span></div>
            </el-form-item>
...
import { listQuantumCredentialAll } from "@/api/credentials"
...
export default {
  ...
  methods: {
    ...
    getCredentials() {
      listQuantumCredentialAll().then((data) => {
