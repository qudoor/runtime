<template>
  <div>
    <div style="position: absolute;right: 10px;z-index: 200">
      <el-button size="large" v-if="isRun" icon="el-icon-video-pause" @click="changeMode()" style="float: right;">
      </el-button>
      <el-button size="large" v-if="!isRun" icon="el-icon-video-play" @click="changeMode()" style="float: right;">
      </el-button>
    </div>
    <div>
...
export default {
  ...
  methods: {
    init() {
      ...
      // let fun = getProvisionerLog
      // if (logId !== undefined) {
      // fun = getAppenvProvisionerLog
      // } else {
      // fun = getAppenvLog
      // }
      // if (logId !== undefined) {
      // fun = getProvisionerLog
      // } else {
      // fun = getClusterLog
      // }
